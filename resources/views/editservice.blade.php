...
<div class="main-panel">
  <div class="content-wrapper">
    <div class="container bootstrap snippets bootdey">
        <h3 class="text-secondary">Edit Service</h3>
          <hr>
        <div class="row">
          ...
          <div class="col-md-9 personal-info">
            ...
            <form class="form-horizontal" role="form">
              <div class="form-group">
                ...
                <div class="col-lg-8">
                  <input class="form-control" type="text" value="{{ old('name', $service->name)}}">
                </div>
              </div>
              <div class="form-group">
                <label class="col-lg-3 control-label">Description:</label>
                <div class="col-lg-8">
                    <textarea class="form-control" id="" cols="63.5" rows="10"> {{$service->description}}</textarea>
                </div>
              </div>
              <div class="col-lg-8">
