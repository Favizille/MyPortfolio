          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <ul>
                ...
                <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span>favourgabriel50@gmail.com</span></li>
    ...
    <div class="skills container">
      ...
      <div class="row skills-content">
        ...
        <div class="col-lg-6">
          ...
          <div class="progress">
            <span class="skill">Nest JS <i class="val">70%</i></span>
            <div class="progress-bar-wrap">
        ...
        <div class="col-lg-6">
          ...
          <div class="progress">
            <span class="skill">WordPress/CMS <i class="val">65%</i></span>
            <div class="progress-bar-wrap">
              <div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
            </div>
          </div>
          ...
          <div class="progress">
            <span class="skill">Typescript <i class="val">65%</i></span>
            <div class="progress-bar-wrap">
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="resume-item pb-0">
            <h4>Favour Gabriel Akpan</h4>
            <p><em>High initiative and passionate backend developer with 3+ year
              of experience in data manipulation in database. Determined
              and hardworking Web developer who is open to learning and
              has adaptable skills. I am seeking to get an opportunity where I
              can make the best of my potential and contribute to the
              organization's growth.</em></p>
            <p>
            <ul>
              <li>Uyo, Akwa Ibom, Nigeria</li>
              <li>+234 816 292 6146</li>
              <li>favourgabriel50@gmail.com</li>
            </ul>
            </p>
          </div>
          ...
          <div class="resume-item">
            ...
            <h5>2018 - 2022</h5>
            <p><em>University of Uyo, Akwa Ibom, Nigeria</em></p>
          </div>

          <h3 class="resume-title"> Soft Skills</h3>
          <p>The following are soft skills that I posses;</p>
          <ul>
            <li>Ability to learn and adapt quickly.</li>
            <li>Communication Skills.</li>
            <li>Ability to work with distributed teams and environments.</li>
        ...
        <div class="col-lg-6">
          ...
          <div class="resume-item">
            ...
            <p>
            <ul>
              <li> Worked with a team to create a web application (to recreate the slack application)</li>
              <li>Deployment of frontend applications</li>
              <li>Lead a documentation team on a project which I contributed with valuable ideas that helped with the advancement of the project.</li>
            </ul>
            </p>
          </div>
          <div class="resume-item">
            ...
            <p>
            <ul>
              <li> Built web applications using advanced knowledge on laravel framework.</li>
              <li>  Built APIs for consumption by frontend developers.</li>
              <li> Built a Full-Stack School Management System application.</li>
              <li> Was part of a team that built a Hospital Management System.</li>
              <li>  Trained some people in web development.</li>
            </ul>
            </p>
          </div>
          <div class="resume-item">
            ...
            <p>
            <ul>
              <li> Built a Library Management System.</li>
              <li> Created an ecommerce site.</li>
              <li> Built a Blog site.</li>
              <li> Developed APIs for consumption of a blog site.</li>
              <li> Built a payment gateway application.</li>
            </ul>
            </p>
          </div>
          <div class="resume-item">
            ...
            <p>
            <ul>
              <li>  Trained students in softaware development using PHP/ Laravel.</li>
              <li>  Building websites using wordpress</li>
              <li>  Building Fullstack applications using Laravel the php framework</li>
            </ul>
            </p>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
          <div class="icon-box">
            ...
            <p>Efficent and effective use of content management system to produce simple beautiful websites.</p>
          </div>
        </div>
